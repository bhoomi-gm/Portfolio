...
export const about = {
  name: "Bhoomika G M",
  role: "Data Analyst",
  description: "I am a passionate data analyst with expertise in SQL and data visualization. I excel at transforming complex datasets into actionable insights and creating compelling visual narratives that drive decision-making.",
};
...
export const skills = [
  ...
  },
  {
    ...
    items: ["SQL", "Pandas", "NumPy", "Matplotlib"]
  },
  {
    category: "Visualization",
    items: ["Tableau", "Seaborn", "Data Storytelling"]
  },
  {
